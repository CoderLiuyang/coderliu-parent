...
public class WebAppAuthenticationConverter implements AuthenticationConverter {

    private String grant_type = "webapp";
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        // 创建token
        return new WebAppAuthenticationToken(new AuthorizationGrantType(grant_type), clientPrincipal,

...
import cn.coderliu.webapp.WebAppAuthenticationConverter;
import cn.coderliu.webapp.WebAppAuthenticationProvider;
...
//                .apply(new FormIdentityLoginConfigurer())
    ...
    private AuthenticationConverter accessTokenRequestConverter() {
        return new DelegatingAuthenticationConverter(Arrays.asList(
                new WebAppAuthenticationConverter(),
    ...
    private void addCustomOAuth2GrantAuthenticationProvider(HttpSecurity http) {
        ...
        WebAppAuthenticationProvider webAppAuthenticationProvider = new WebAppAuthenticationProvider(
                authenticationManager, authorizationService, oAuth2TokenGenerator());
        http.authenticationProvider(webAppAuthenticationProvider);
    }

...
public class WxAuthenticationToken extends AbstractAuthenticationToken {
     ...
     */
    public WxAuthenticationToken(String code, String clientId, int type, String uuid) {
        super(null);
        this.principal = code;
     ...
     * @param authorities
     */
    public WxAuthenticationToken(Object principal, String clientId, int type, String uuid,

...
import cn.coderliu.granter.DeviceTokenGranter;
import cn.coderliu.granter.MobileAndVerificationCodeTokenGranter;
import cn.coderliu.granter.WxTokenGranter;
...
public class TokenGranterConfig {
    ...
    private List<TokenGranter> getAllTokenGranters() {
        ...
        if (authenticationManager != null) {
            // 添加手机号加验证码授权模式
            tokenGranters.add(new MobileAndVerificationCodeTokenGranter(authenticationManager, tokenServices, clientDetailsService, requestFactory));
            // 添加微信授权模式
            tokenGranters.add(new WxTokenGranter(authenticationManager, tokenServices, clientDetailsService, requestFactory));
            // 添加设备信息授权模式
            tokenGranters.add(new DeviceTokenGranter(authenticationManager, tokenServices, clientDetailsService, requestFactory));
        }
